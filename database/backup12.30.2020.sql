...
INSERT INTO `commands` (`command_record_id`, `info_level`, `info_id`, `command_type`, `command_sensor`, `command_name`, `command_value`) VALUES (1,3,1,'write','HVAC_cool','AC_off','1'),(2,3,1,'write','HVAC_cool','AC_on','0'),(4,2,1,'broadcast','group','lights_off','lights_off'),(5,2,1,'broadcast','group','lights_on','lights_on'),(6,2,1,'broadcast','group','status','status'),(7,3,1,'write','HVAC_fan','fan_off','1'),(8,3,1,'write','HVAC_fan','fan_on','0'),(9,3,1,'write','HVAC_heat','heat_off','1'),(10,3,1,'write','HVAC_heat','heat_on','0'),(11,2,1,'hue','group','hue_lights_dim','{\"bri\": 50, \"on\": true}'),(12,2,1,'hue','group','hue_lights_off','{\"on\": false}'),(13,2,1,'hue','group','hue_lights_on','{\"bri\": 255, \"on\": true}'),(14,3,1,'write','light','lights_off','1'),(15,3,1,'write','light','lights_on','0'),(17,3,1,'read','all','status','None'),(18,2,1,'broadcast','thing1','AC_off','AC_off'),(19,2,1,'broadcast','thing1','heat_on','heat_on'),(20,2,1,'broadcast','thing1','heat_off','heat_off'),(21,2,1,'broadcast','thing1','fan_off','fan_off'),(22,2,1,'broadcast','thing1','fan_on','fan_on'),(23,2,1,'broadcast','thing1','AC_on','AC_on'),(25,2,1,'broadcast','room','status','status'),(31,2,1,'hue','Kitchen_backlight','hue_kitchen_backlight','{\"bri\": 255, \"on\": true}'),(33,3,2,'read','all','status','None'),(34,3,2,'write','light','lights_on','0'),(35,3,2,'write','light','lights_off','1'),(36,3,2,'write','fan','fan_off','1'),(37,3,2,'write','fan','fan_on','0'),(38,2,2,'broadcast','group','status','status'),(41,2,2,'broadcast','room','status','status'),(54,2,2,'hue','group','hue_off','{\"on\": false}'),(55,2,2,'hue','group','hue_dim','{\"bri\": 50, \"on\": true}'),(56,2,2,'hue','group','hue_on','{\"bri\": 255, \"on\": true}'),(62,2,2,'broadcast','group','lights_off','lights_off'),(63,2,2,'broadcast','group','lights_on','lights_on'),(64,2,2,'broadcast','group','fan_on','fan_on'),(65,2,2,'broadcast','group','fan_off','fan_off'),(68,1,1,'HVAC','heat','set_cool_to','75'),(69,1,1,'HVAC','cool','set_heat_to','75'),(70,1,1,'HVAC','check','check_temperature','None'),(71,1,1,'HVAC','off','turn_off_HVAC','None'),(72,2,2,'sonos','speak','sonos_front_door','The front door is open.');
...
INSERT INTO `groups_rooms_things` (`group_record_id`, `group_id`, `info_id`, `info_level`) VALUES (4,1,1,3),(5,2,1,2),(6,3,2,3),(7,2,2,2),(8,2,1,1);
...
CREATE TABLE `history` (
  `history_record_id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `history` (`history_record_id`, `sensor_type`, `sensor_name`, `sensor_value`, `history_timestamp`) VALUES (1,'light','light2',0,'2020-12-29 19:04:40'),(2,'motion','motion2',0,'2020-12-29 19:04:40'),(3,'door','door1',0,'2020-12-29 19:04:40'),(4,'fan','fan2',0,'2020-12-29 19:04:40'),(5,'light','light2',0,'2020-12-29 19:10:09'),(6,'motion','motion2',0,'2020-12-29 19:10:09'),(7,'door','door1',0,'2020-12-29 19:10:09'),(8,'fan','fan2',0,'2020-12-29 19:10:09'),(9,'motion','motion1',0,'2020-12-29 19:10:09'),(10,'light','light1',0,'2020-12-29 19:10:09'),(11,'window','window1',0,'2020-12-29 19:10:09'),(12,'HVAC_fan','fan1',1,'2020-12-29 19:10:09'),(13,'HVAC_heat','heat1',1,'2020-12-29 19:10:09'),(14,'HVAC_cool','cool1',1,'2020-12-29 19:10:09'),(15,'humidity','humidity1',19,'2020-12-29 19:10:09'),(16,'temperature','temperature1',23,'2020-12-29 19:10:09'),(17,'LDR','LDR1',1348,'2020-12-29 19:10:09'),(18,'motion','motion2',0,'2020-12-29 19:10:09'),(19,'motion','motion1',0,'2020-12-29 19:14:09'),(20,'light','light1',0,'2020-12-29 19:14:09'),(21,'window','window1',0,'2020-12-29 19:14:09'),(22,'HVAC_fan','fan1',1,'2020-12-29 19:14:09'),(23,'HVAC_heat','heat1',1,'2020-12-29 19:14:09'),(24,'HVAC_cool','cool1',1,'2020-12-29 19:14:09'),(25,'humidity','humidity1',19,'2020-12-29 19:14:09'),(26,'temperature','temperature1',23,'2020-12-29 19:14:09'),(27,'LDR','LDR1',1353,'2020-12-29 19:14:09'),(28,'motion','motion2',0,'2020-12-29 19:14:09'),(29,'motion','motion1',0,'2020-12-29 19:32:15'),(30,'light','light1',0,'2020-12-29 19:32:15'),(31,'window','window1',0,'2020-12-29 19:32:15'),(32,'HVAC_fan','fan1',1,'2020-12-29 19:32:15'),(33,'HVAC_heat','heat1',1,'2020-12-29 19:32:15'),(34,'HVAC_cool','cool1',1,'2020-12-29 19:32:15'),(35,'humidity','humidity1',18,'2020-12-29 19:32:15'),(36,'temperature','temperature1',24,'2020-12-29 19:32:15'),(37,'LDR','LDR1',1362,'2020-12-29 19:32:15'),(38,'motion','motion2',0,'2020-12-29 19:32:15'),(39,'light','light2',0,'2020-12-30 10:34:15'),(40,'motion','motion2',0,'2020-12-30 10:34:15'),(41,'door','door1',0,'2020-12-30 10:34:15'),(42,'fan','fan2',0,'2020-12-30 10:34:15'),(43,'motion','motion1',0,'2020-12-30 10:34:15'),(44,'light','light1',0,'2020-12-30 10:34:15'),(45,'window','window1',0,'2020-12-30 10:34:15'),(46,'HVAC_fan','fan1',1,'2020-12-30 10:34:15'),(47,'HVAC_heat','heat1',1,'2020-12-30 10:34:15'),(48,'HVAC_cool','cool1',1,'2020-12-30 10:34:15'),(49,'humidity','humidity1',22,'2020-12-30 10:34:15'),(50,'temperature','temperature1',25,'2020-12-30 10:34:15'),(51,'LDR','LDR1',1343,'2020-12-30 10:34:15'),(52,'motion','motion2',0,'2020-12-30 10:34:15');
...
INSERT INTO `hue_groups` (`group_id`, `lights`, `name`, `state`, `action`) VALUES ('1','[\'4\', \'5\', \'6\', \'7\', \'8\', \'9\', \'10\', \'11\']','Kitchen','{\'all_on\': True, \'any_on\': True}','{\'on\': True, \'bri\': 254, \'hue\': 8402, \'sat\': 140, \'effect\': \'none\', \'xy\': [0.4575, 0.4099], \'ct\': 366, \'alert\': \'none\', \'colormode\': \'xy\'}'),('2','[\'13\', \'14\', \'15\', \'2\', \'3\']','Lab','{\'all_on\': False, \'any_on\': True}','{\'on\': True, \'bri\': 254, \'hue\': 14988, \'sat\': 141, \'effect\': \'none\', \'xy\': [0.4575, 0.4101], \'ct\': 366, \'alert\': \'none\', \'colormode\': \'ct\'}'),('3','[\'1\', \'12\', \'18\', \'21\']','Hallway','{\'all_on\': False, \'any_on\': True}','{\'on\': True, \'bri\': 254, \'hue\': 14988, \'sat\': 141, \'effect\': \'none\', \'xy\': [0.4575, 0.4101], \'ct\': 366, \'alert\': \'none\', \'colormode\': \'ct\'}'),('4','[\'23\', \'22\']','Guest Bedroom','{\'all_on\': True, \'any_on\': True}','{\'on\': True, \'bri\': 254, \'hue\': 14988, \'sat\': 141, \'effect\': \'none\', \'xy\': [0.4575, 0.4101], \'ct\': 366, \'alert\': \'none\', \'colormode\': \'ct\'}'),('5','[\'26\', \'24\']','Master Bedroom','{\'all_on\': True, \'any_on\': True}','{\'on\': True, \'bri\': 254, \'hue\': 14988, \'sat\': 141, \'effect\': \'none\', \'xy\': [0.4575, 0.4101], \'ct\': 366, \'alert\': \'none\', \'colormode\': \'ct\'}'),('7','[\'9\', \'10\', \'11\']','Kitchen_backlight','{\'all_on\': True, \'any_on\': True}','{\'on\': True, \'bri\': 254, \'hue\': 14988, \'sat\': 141, \'effect\': \'none\', \'xy\': [0.4575, 0.4101], \'ct\': 366, \'alert\': \'none\', \'colormode\': \'ct\'}'),('8','[\'4\', \'5\', \'6\', \'7\', \'8\', \'9\', \'10\', \'11\', \'13\', \'14\', \'15\', \'2\', \'3\', \'1\', \'12\', \'18\', \'21\', \'23\', \'22\', \'26\', \'24\']','Home','{\'all_on\': True, \'any_on\': True}','{\'on\': True, \'bri\': 254, \'hue\': 14988, \'sat\': 141, \'effect\': \'none\', \'xy\': [0.4575, 0.4101], \'ct\': 366, \'alert\': \'select\', \'colormode\': \'ct\'}');
...
-- Dump completed on 2020-12-30  9:35:41
